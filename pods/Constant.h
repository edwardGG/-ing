...
/*
    网址
 */
#define kLivePath @"http://live.ximalaya.com/live-web/v1/getHomePageRadiosList?device=iPhone%20HTTP"
...
//全局导航栏的颜色
#define kNaviBarBGColor [UIColor whiteColor];//暂定白色，需要时自行修改
//实现归档和解档, 需要遵循 NSCoding 协议  和 引入 <objc/runtime.h>

#define kEdwardCoding \
